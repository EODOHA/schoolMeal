...
function NutritionManageEdit() {
    ...
    const handleSave = async (e) => {
        ...
        formData.append("title", nutritionManage.title);
        formData.append("writer", nutritionManage.writer);
        formData.append("content", nutritionManage.content);

        if (nutritionManage.file) {
            formData.append("file", nutritionManage.file);
        } else if (nutritionManage.fileId) {
            formData.append("fileId", nutritionManage.fileId);
        }

        try {
            await axios.put(`${SERVER_URL}nutritionManage/update/${id}`, formData, {
                headers: {
            ...
            alert("수정되었습니다.");
            navigate("/mealResource/nutrition-manage");
        } catch (err) {
                ...
                <div className="edu-card-body">
                    ...
                    <form onSubmit={handleSave}>
                        ...
                        <div className="edu-button-group">
                            ...
                            <Button variant="outlined" onClick={() => navigate(`/mealResource/nutrition-manage/${id}`)}>
                                취소
                            </Button>
                        </div>
                    </form>
...
export default NutritionManageEdit;
