...
function NutritionManageDetail() {
    const { id } = useParams(); // URL에서 id 값을 받아옴
    const [nutritionManage, setNutritionManage] = useState(null);
    ...
    const update = () => {
        navigate(`/mealResource/nutrition-manage/update/${id}`); // 수정 페이지로 이동
    };
    ...
    const deleteForm = () => {
        ...
        axios
            .delete(`${SERVER_URL}nutritionManage/delete/${id}`, {
                headers: {
                    Authorization: `${token}`,
                },
            })
                    ...
                    <form>
                        ...
                        <div className="edu-button-group">
                            ...
                            <Button
                                variant="outlined"
                                color="primary"
                                onClick={() => navigate("/mealResource/nutrition-manage")}
                            >
                                목록
                            </Button>
...
export default NutritionManageDetail;
