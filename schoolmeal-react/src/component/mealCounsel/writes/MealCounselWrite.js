...
function MealCounselWrite() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${SERVER_URL}mealCounsel/writepost`, formData, {
            headers: {
                Authorization: `${token}`,
            },
        })
    ...
    return (
        <div className="meal-counsel-write-container">
            <div className="meal-counsel-card">
                <div className="meal-counsel-card-body">
                    <h2>새 게시글 작성</h2>
                    {error && <div className="meal-counsel-error-message">{error}</div>}
