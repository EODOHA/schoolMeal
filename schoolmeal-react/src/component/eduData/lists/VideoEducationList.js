...
function VideoEducationList() {
    ...
    const totalPages = Math.ceil(videoEducation.length / postsPerPage); //전체 페이지 수
        ...
        <div className="edu-list-container">
            ...
            <div className="pagination">
                <Button
                    ...
                    disabled={currentPage === 1 || videoEducation.length === 0}
                >
                    <HiChevronDoubleLeft />
                </Button>
                <Button
                ...
                <Button
                    ...
                    disabled={currentPage === totalPages || videoEducation.length === 0}
                >
                    <HiChevronRight />
                </Button>
                <Button
