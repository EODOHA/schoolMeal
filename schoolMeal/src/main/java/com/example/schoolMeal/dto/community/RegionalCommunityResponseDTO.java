...
public class RegionalCommunityResponseDTO {
	...
	// 파라미터를 받는 생성자
	public RegionalCommunityResponseDTO(Long id, String title, String content, String author, LocalDateTime createdDate,
			LocalDateTime updatedDate, RegionCategory region, int viewCount) {
		this.id = id;
		this.title = title;
