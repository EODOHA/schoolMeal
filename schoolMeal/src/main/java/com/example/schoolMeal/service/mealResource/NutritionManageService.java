...
//
//	// 영양사 게시글 조회
//	public List<NutritionManage> nutritionManageByNutritionistFilter(String nutritionistFilter) {
//		return nutritionManageRepository.findByNutritionistFilter(nutritionistFilter);
//	}
//
//	// 영양교사 게시글 조회
//	public List<NutritionManage> nutritionManageByNutritionTeacherFilter(String nutritionTeacherFilter) {
//		return nutritionManageRepository.findByNutritionTeacherFilter(nutritionTeacherFilter);
//	}
//
//	// 특정 파일 정보 조회
//	public FileUrl getFileUrlByNutritionManageId(Long id) {
//		// 해당 ID의 NutritionManage 조회
//		NutritionManage nutManage = nutritionManageRepository.findById(id)
//				.orElseThrow(() -> new IllegalArgumentException("해당 ID의 게시글이 존재하지 않습니다: " + id));
//
//		// NutritionManage에 연결된 FileUrl 조회
//		return nutManage.getFileUrl(); // 파일이 없으면 null 반환
//	}
//
